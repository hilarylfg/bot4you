...
-   [x] Добавить авторизацию + вход через разные платформы (3 минимум)
...
-   [x] Автофокус в инпуте при загрузке
...
-   [x] Выбор темы (темная / светлая / системная)
-   [x] Сбросить историю
-   [x] Изменить имя пользователя
